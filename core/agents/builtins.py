...
BUILTIN_AGENTS = [
    {
        ...
        "recommended_tools": ["list_findings", "get_finding", "create_case", "recall_entity"],
        "max_tokens": 2048,
...
6. Document thoroughly for audit trail
    ...
    },
    {
        ...
        "recommended_tools": ["list_findings", "create_approval_action", "recall_entity"],
        "max_tokens": 16384,
        "enable_thinking": True,
        "thinking_budget": 10000,
...
6. Document insights and recommend detections
    ...
    },
    {
        ...
        "recommended_tools": ["list_findings", "create_case", "get_technique_rollup", "recall_entity"],
        "max_tokens": 16384,
        "enable_thinking": True,
...
6. Build attack narrative and visualize
    ...
    },
    {
        ...
        "recommended_tools": ["get_finding", "update_case", "create_approval_action", "recall_entity"],
        "max_tokens": 4096,
        "enable_thinking": False,
...
- <0.70: Needs more investigation
    ...
    },
    {
        ...
        "recommended_tools": ["get_case", "list_cases", "list_findings", "recall_entity"],
        "max_tokens": 8192,
        "enable_thinking": False,
...
6. Provide actionable intelligence and IOCs to hunt
    ...
    },
    {
        ...
        "recommended_tools": ["list_findings", "get_finding", "list_cases", "recall_entity"],
        "max_tokens": 4096,
        "enable_thinking": False,
